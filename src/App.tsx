...
const App = () => {
  ...
  const color_mode_handler = () => {
    const get_color_mode = color_mode === "dark_mode" ? "light_mode" : "dark_mode";
  ...
  return (
    <BrowserRouter>
      <div 
        id="color_mode" 
        className={color_mode === null || color_mode === "dark_mode" ? "dark_mode" : "light_mode"}
      >
        <Header 
          color_mode={color_mode === "dark_mode" ? "Light Mode" : "Dark Mode"}
